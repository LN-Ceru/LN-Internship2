...
PRS_5e08 =  read.csv("./MDD_PRS_5e08.score", header = TRUE, sep = '')
...
write.csv(norm_prot_results, "/exports/igmm/eddie/GenScotDepression/users/Laurence/assoc_output/MDD_mediumrare_prot_res.csv", row.names = F, quote = F)
