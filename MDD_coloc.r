...
# '/exports/igmm/eddie/GenScotDepression/users/Laurence/sumstats_MDD_bp/Edited2_PGC3_MDD_wave3.european.autosome.public.v3.vcf.tsv'
...
for (i in 1:length(proteins_uniprot_list)) {
  ...
  # filtering and clumping in the protein# exposure data + selecting top SNPs
...
write.csv(coloc_full_output, "/exports/igmm/eddie/GenScotDepression/users/Laurence/coloc_output/MDD_coloc1.csv", row.names = F)
