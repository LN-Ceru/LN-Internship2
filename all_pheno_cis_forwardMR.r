...
for (i in 1:length(proteins_uniprot_list)) {
    ...
    # if no SNPS in the cis window meet significance then reset the p value threshold to the lowest available
    ...
    ggsave(scatter_one[[1]], file = paste0("/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/BPD_CIS_", protein, "_FORWARD_MR_scatterplot.pdf"), width = 7, height = 7)
    ...
    if (dim(harmonised_data)[1] > 2) {
        ...
        write.table(egger_intercept, paste0("/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/BPD_CIS_", protein, "_FORWARD_EGGER.tsv"), sep = "\t", row.names = F, quote = F)
    }
...
write.table(RES_mr_test, "/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/BPD_CIS_prot_FORWARD_WR.tsv", sep = "\t", row.names = F, quote = F)

write.table(mr_output_P09923, "/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/BPD_CIS_P09923_FORWARD_WR.tsv", sep = "\t", row.names = F, quote = F)
write.table(mr_output_Q9UKS6, "/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/BPD_CIS_Q9UKS6_FORWARD_WR.tsv", sep = "\t", row.names = F, quote = F)
write.table(mr_output_P49863, "/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/BPD_CIS_P49863_FORWARD_WR.tsv", sep = "\t", row.names = F, quote = F)
write.table(mr_output_O00478, "/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/BPD_CIS_O00478_FORWARD_WR.tsv", sep = "\t", row.names = F, quote = F)

write.table(mr_output_Q29983, "/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/BPD_CIS_Q29983_FORWARD_WR.tsv", sep = "\t", row.names = F, quote = F)
write.table(mr_output_Q29980, "/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/BPD_CIS_Q29980_FORWARD_WR.tsv", sep = "\t", row.names = F, quote = F)
...
read_exposure_data <- function(filename, clump=FALSE, sep=" ", phenotype_col="Phenotype", snp_col="SNP", beta_col="beta", se_col="se", eaf_col="eaf", effect_allele_col="effect_allele", other_allele_col="other_allele", pval_col="pval", units_col="units", ncase_col="ncase", ncontrol_col="ncontrol", samplesize_col="samplesize", gene_col="gene", id_col="id", min_pval=1e-200, log_pval=FALSE, chr_col="chr", pos_col="pos")
{
  ...
  #cis window 
  #exposure_data_cis1 = exposure_data[exposure_data$pos.exposure < protein_start_pos[i] - 500000,]  
  #exposure_data_cis = exposure_data[exposure_data$pos.exposure > protein_end_pos[i] + 500000,]
  ...
  scatter_one <- mr_scatter_plot(mr_output, harmonised_data)
  ggsave(scatter_one[[1]], file = paste0("/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/SCZ_CIS_", protein, "_FORWARD_MR_scatterplot.pdf"), width = 7, height = 7)


  if (dim(harmonised_data)[1] > 2) {
    egger_intercept <- mr_pleiotropy_test(harmonised_data)
    write.table(egger_intercept, paste0("/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/SCZ_", protein, "_CIS_FORWARD_EGGER.tsv"), sep = "\t", row.names = F, quote = F)
  }
}



write.table(RES_mr_test, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/SCZ_prot_CIS_FORWARD_WR.tsv', sep = '\t', row.names = F, quote = F)

write.table(mr_output_O00478, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/SCZ_O00478_CIS_FORWARD_MR.tsv', sep = '\t', row.names = F, quote = F)
write.table(mr_output_P16581, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/SCZ_P16581_CIS_FORWARD_MR.tsv', sep = '\t', row.names = F, quote = F)
...
for (i in 1:length(proteins_uniprot_list)) {
  ...
  outcome_data = read_outcome_data(filename = '/exports/igmm/eddie/GenScotDepression/users/Laurence/sumstats_scz_bp/pgc-mdd2022-noGenScot-eur-v3.49.24.11.pgc',
    ...
    scatter_one <- mr_scatter_plot(mr_output, harmonised_data)
    ggsave(scatter_one[[1]], file = paste0("/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/MDD_CIS_", protein, "_FORWARD_MR_scatterplot.pdf"), width = 7, height = 7)


  if (dim(harmonised_data)[1] > 2) {
    egger_intercept <- mr_pleiotropy_test(harmonised_data)
    write.table(egger_intercept, paste0("/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/MDD_", protein, "_CIS_FORWARD_EGGER.tsv"), sep = "\t", row.names = F, quote = F)
  }
}

write.table(RES_mr_test, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/MDD_prot_CIS_FORWARD_WR.tsv', sep = '\t', row.names = F, quote = F)

write.table(mr_output_Q9Y253, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/MDD_Q9Y253_CIS_FORWARD_MR.tsv', sep = '\t', row.names = F, quote = F)
#write.table(mr_output_Q96EU7, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/MDD_Q96EU7_CIS_FORWARD_MR.tsv', sep = '\t', row.names = F, quote = F)
write.table(mr_output_P16442, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/MDD_P16442_CIS_FORWARD_MR.tsv', sep = '\t', row.names = F, quote = F)
write.table(mr_output_O00478, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/MDD_O00478_CIS_FORWARD_MR.tsv', sep = '\t', row.names = F, quote = F)
