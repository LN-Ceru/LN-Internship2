...
PRS_0.05 =  read.csv("./MDD_prs0.05.score", header = TRUE, sep = '')
...
norm_prot_results <- data.frame(SeqId = 1:length, mddPRS_beta = 1:length, mddPRS_SE = 1:length, mddPRS_P = 1:length)
...
write.csv(norm_prot_results, "/exports/igmm/eddie/GenScotDepression/users/Laurence/assoc_output/MDD_mediumrare_prot_res_0.05.csv", row.names = F, quote = F)
