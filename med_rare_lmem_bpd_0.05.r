...
PRS_0.05 =  read.csv("./BPD_prs0.05.score", header = TRUE, sep = '')
...
write.csv(norm_prot_results, "/exports/igmm/eddie/GenScotDepression/users/Laurence/assoc_output/BPD_mediumrare_prot_res_0.05.csv", row.names = F, quote = F)
