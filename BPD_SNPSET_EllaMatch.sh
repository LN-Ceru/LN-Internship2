...
Rscript ../software/PRSice.R \
    ...
    --extract /exports/igmm/eddie/GenScotDepression/users/Laurence/Scores/BPD_ELLAMATCH_unrelated01.scores.snp \
    --thread 5 \
    --stat BETA \
    --pvalue P \
    --snp SNP \
    ...
    --fastscore \
    --all-score \
    --out /exports/igmm/eddie/GenScotDepression/users/Laurence/Scores/SNPSET_BPD_ELLAMatch 
