...
for(i in 1:length(proteins_uniprot_list)){
 ...
 # TRANS window
  ...
  ggsave(scatter_one[[1]], file = paste0("/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/SCZ_TRANS_" ,protein, "_INVERSE_MR_scatterplot.pdf"), width = 7, height = 7)



  if (dim(harmonised_data)[1] > 2) {
    egger_intercept <- mr_pleiotropy_test(harmonised_data)
    write.table(egger_intercept, paste0("/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/SCZ_", protein, "_TRANS_EGGER_INVERSE.tsv"), sep = "\t", row.names = F, quote = F)
  }
}
...
write.table(RES_mr_test, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/SCZ_prot_TRANS_INVERSE_WR.tsv', sep = '\t', row.names = F, quote = F)

write.table(mr_output_O00478, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/SCZ_O00478_TRANS_INVERSE_MR.tsv', sep = '\t', row.names = F, quote = F)
write.table(mr_output_P16581, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/SCZ_P16581_TRANS_INVERSE_MR.tsv', sep = '\t', row.names = F, quote = F)
...
for(i in 1:length(proteins_uniprot_list)){
 ...
 # TRANS window
  ...
  RES_mr_test[i, 'wr_p'] = mr_wr_results$pval
    ...
    scatter_one <- mr_scatter_plot(mr_output, harmonised_data)
    ggsave(scatter_one[[1]], file = paste0("/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/MDD_TRANS_" ,protein, "_INVERSE_MR_scatterplot.pdf"), width = 7, height = 7)


  if (dim(harmonised_data)[1] > 2) {
    egger_intercept <- mr_pleiotropy_test(harmonised_data)
    write.table(egger_intercept, paste0("/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/MDD_", protein, "_TRANS_EGGER_INVERSE.tsv"), sep = "\t", row.names = F, quote = F)
  }
}
...
write.table(RES_mr_test, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/MDD_prot_TRANS_INVERSE_WR.tsv', sep = '\t', row.names = F, quote = F)

write.table(mr_output_Q9Y253, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/MDD_Q9Y253_TRANS_INVERSE_MR.tsv', sep = '\t', row.names = F, quote = F)
#write.table(mr_output_Q96EU7, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/MDD_Q96EU7_TRANS_INVERSE_MR.tsv', sep = '\t', row.names = F, quote = F)
write.table(mr_output_P16442, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/MDD_P16442_TRANS_INVERSE_MR.tsv', sep = '\t', row.names = F, quote = F)
write.table(mr_output_O00478, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/MDD_O00478_TRANS_INVERSEMR.tsv', sep = '\t', row.names = F, quote = F)
...
for(i in 1:length(proteins_uniprot_list)){
 ...
 # TRANS window
  ...
  RES_mr_test[i, 'wr_p'] = mr_wr_results$pval
    ...
    scatter_one <- mr_scatter_plot(mr_output, harmonised_data)
    ggsave(scatter_one[[1]], file = paste0("/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/BPD_TRANS_", protein, "_INVERSE_MR_scatterplot.pdf"), width = 7, height = 7)


  if (dim(harmonised_data)[1] > 2) {
    egger_intercept <- mr_pleiotropy_test(harmonised_data)
    write.table(egger_intercept, paste0("/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/BPD_", protein, "_TRANS_EGGER_INVERSE.tsv"), sep = "\t", row.names = F, quote = F)
  }
}

# setting up the results table # 

write.table(RES_mr_test, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/BPD_prot_TRANS_INVERSE_WR.tsv', sep = '\t', row.names = F, quote = F)

write.table(mr_output_P09923, '/exports/igmm/eddie/GenScotDepression/users/Laurence/cis_trans_allprots/mr_output/BPD_P09923_TRANS_INVERSE_WR.tsv', sep = '\t', row.names = F, quote = F)
write.table(mr_output_Q9UKS6, '/exports/igmm/eddie/GenScotDepression/users/Laurence/cis_trans_allprots/mr_output/BPD_Q9UKS6_TRANS_INVERSE_WR.tsv', sep = '\t', row.names = F, quote = F)
write.table(mr_output_P49863, '/exports/igmm/eddie/GenScotDepression/users/Laurence/cis_trans_allprots/mr_output/BPD_P49863_TRANS_INVERSE_WR.tsv', sep = '\t', row.names = F, quote = F)
write.table(mr_output_O00478, '/exports/igmm/eddie/GenScotDepression/users/Laurence/cis_trans_allprots/mr_output/BPD_O00478_TRANS_INVERSE_WR.tsv', sep = '\t', row.names = F, quote = F)
