#ALL_PHENOS_INVERSE_FULL_GENOME
#
...
for(i in 1:length(proteins_uniprot_list)){
  ...
  exposure_data_trim = exposure_data[exposure_data$SNP %in% outcome_data$SNP,]
  outcome_data = outcome_data[outcome_data$SNP %in% exposure_data$SNP,]


  print("exposure_data_trim dim")
  print(dim(exposure_data_trim))


  #filtering and clumping in the protein# exposure data 
  exposure_data_topsnps =  exposure_data_trim[exposure_data_trim$pval.exposure < 5e-08,]
  ...
  if (dim(exposure_data_topsnps_maf)[1] == 0) {
    exposure_data_pre_maf = exposure_data_trim %>% filter(eaf.exposure <0.99 & eaf.exposure > 0.01) 
  ...
  ggsave(scatter_one[[1]], file = paste0("/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/SCZ_FULL_" ,protein, "_INVERSE_MR_scatterplot.pdf"), width = 7, height = 7)



  if (dim(harmonised_data)[1] > 2) {
    egger_intercept <- mr_pleiotropy_test(harmonised_data)
    write.table(egger_intercept, paste0("/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/SCZ_", protein, "_FULL_EGGER_INVERSE.tsv"), sep = "\t", row.names = F, quote = F)
  }
}
...
write.table(RES_mr_test, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/SCZ_prot_FULL_INVERSE_WR.tsv', sep = '\t', row.names = F, quote = F)

write.table(mr_output_O00478, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/SCZ_O00478_FULL_INVERSE_MR.tsv', sep = '\t', row.names = F, quote = F)
write.table(mr_output_P16581, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/SCZ_P16581_FULL_INVERSE_MR.tsv', sep = '\t', row.names = F, quote = F)
...
for(i in 1:length(proteins_uniprot_list)){
  ...
  print("exposure_data_transs dim")
  print(dim(exposure_data_trim))
  ...
  RES_mr_test[i, 'wr_p'] = mr_wr_results$pval
    ...
    scatter_one <- mr_scatter_plot(mr_output, harmonised_data)
    ggsave(scatter_one[[1]], file = paste0("/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/MDD_FULL_" ,protein, "_INVERSE_MR_scatterplot.pdf"), width = 7, height = 7)


  if (dim(harmonised_data)[1] > 2) {
    egger_intercept <- mr_pleiotropy_test(harmonised_data)
    write.table(egger_intercept, paste0("/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/MDD_", protein, "_FULL_EGGER_INVERSE.tsv"), sep = "\t", row.names = F, quote = F)
  }
}
...
write.table(RES_mr_test, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/MDD_prot_FULL_INVERSE_WR.tsv', sep = '\t', row.names = F, quote = F)

write.table(mr_output_Q9Y253, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/MDD_Q9Y253_FULL_INVERSE_MR.tsv', sep = '\t', row.names = F, quote = F)
#write.table(mr_output_Q96EU7, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/MDD_Q96EU7_FULL_INVERSE_MR.tsv', sep = '\t', row.names = F, quote = F)
write.table(mr_output_P16442, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/MDD_P16442_FULL_INVERSE_MR.tsv', sep = '\t', row.names = F, quote = F)
write.table(mr_output_O00478, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/MDD_O00478_FULL_INVERSEMR.tsv', sep = '\t', row.names = F, quote = F)
...
for(i in 1:length(proteins_uniprot_list)){
  ...
  RES_mr_test[i, 'wr_p'] = mr_wr_results$pval
    ...
    scatter_one <- mr_scatter_plot(mr_output, harmonised_data)
    ggsave(scatter_one[[1]], file = paste0("/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/BPD_FULL_", protein, "_INVERSE_MR_scatterplot.pdf"), width = 7, height = 7)


  if (dim(harmonised_data)[1] > 2) {
    egger_intercept <- mr_pleiotropy_test(harmonised_data)
    write.table(egger_intercept, paste0("/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/BPD_", protein, "_FULL_EGGER_INVERSE.tsv"), sep = "\t", row.names = F, quote = F)
  }
}

# setting up the results table # 

write.table(RES_mr_test, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/BPD_prot_FULL_INVERSE_WR.tsv', sep = '\t', row.names = F, quote = F)

write.table(mr_output_P09923, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/BPD_P09923_FULL_INVERSE_WR.tsv', sep = '\t', row.names = F, quote = F)
write.table(mr_output_Q9UKS6, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/BPD_Q9UKS6_FULL_INVERSE_WR.tsv', sep = '\t', row.names = F, quote = F)
write.table(mr_output_P49863, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/BPD_P49863_FULL_INVERSE_WR.tsv', sep = '\t', row.names = F, quote = F)
write.table(mr_output_O00478, '/exports/igmm/eddie/GenScotDepression/users/Laurence/mr_output/cis_trans_allprots/BPD_O00478_FULL_INVERSE_WR.tsv', sep = '\t', row.names = F, quote = F)
